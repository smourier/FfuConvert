...
namespace FfuConvert.Utilities
{
    public static class CommandLine
    {
        ...
        public static string GetNullifiedArgument(int index)
        {
            return GetNullifiedArgument(index, null);
        }

        public static string GetNullifiedArgument(int index, string defaultValue)
        {
        ...
        public static string GetNullifiedArgument(string name)
        {
            return GetNullifiedArgument(name, null);
        }
