...
namespace FfuConvert.Utilities
{
    public static class Conversions
    {
        ...
        public static long ToFileTime(DateTime dt)
        {
            return ToFileTimeUtc(dt.ToUniversalTime());
        }
        ...
        {
            return bytes != null ? ToHexa(bytes, 0, bytes.Length) : "0x";
        }

        public static string ToHexa(this byte[] bytes, int count)
        {
            return ToHexa(bytes, 0, count);
        }
        ...
        public static string ToHexaDump(string text)
        {
            return ToHexaDump(text, null);
        }
        ...
        public static string ToHexaDump(this IntPtr ptr, int count)
        {
            return ToHexaDump(ptr, 0, count, null, true);
        }
        ...
        public static string ToHexaDump(this byte[] bytes, int count)
        {
            return ToHexaDump(bytes, 0, count, null, true);
        }

        public static string ToHexaDump(this byte[] bytes, int offset, int count)
        {
            return ToHexaDump(bytes, offset, count, null, true);
        }
        ...
        {
            return SplitToList<T>(text, null, separators);
        }
